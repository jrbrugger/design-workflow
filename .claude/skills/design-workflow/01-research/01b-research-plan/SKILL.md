...
- After gap analysis is complete (from `01a-gap-analysis`)
- When research scope changes mid-project
- When starting any new research initiative
...
- [ ] **Research brief** → Complete 11-section brief → posted to Notion
...
Load settings from `assets/config.json`:
...
- `assets/research-brief-template.md` — Blank template for copy/paste
- `assets/rbb-calendar-example-annotated.md` — Annotated real-world example (Calendar Widget)
- `assets/research-brief-checklist.md` — 50+ validation items before sharing your brief
- `assets/config.json` — Notion publishing configuration
